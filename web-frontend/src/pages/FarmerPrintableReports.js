                ...
                <table className="print-table">
                  ...
                  <tbody>
                    {topProducts.length > 0 ? (
                      ...
                      <tr><td colSpan="2" className="text-center">No product revenue data available for this period.</td></tr>
                    )}
                  </tbody>
                </table>
              </div>
            ...
            {selectedSections.orderStatus && (
              <div className="report-section">
                ...
                <table className="print-table compact-table">
                  ...
                  <tbody>
                    {['pending', 'approved', 'ready_for_ship', 'picked_up', 'on_the_way', 'delivered', 'cancelled', 'rejected'].map(status => {
                      ...
                      return (
                        <tr key={status}>
                          ...
                          <td className="text-right mono">{count}</td>
